        ...
        <div class="content__wrap">
            ...
            <div class="card">
                <div class="card-header mb-3">
                    <h5 class="card-title mb-3">List of Companies</h5>
                    <livewire:flash-message.flash-message />
                    <div class="row">

                        <!-- Left toolbar -->
                        <div class="col-md-6 d-flex gap-1 align-items-center mb-3">
                            <button wire:click="createCompany" class="btn btn-primary hstack gap-2 align-self-center">
...
@include('layouts.scripts.company-scripts')
@endsection